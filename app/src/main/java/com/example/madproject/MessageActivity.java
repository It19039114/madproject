...
import com.example.madproject.Adapter.MessageAdapter;
import com.example.madproject.Model.Chat;
...
public class MessageActivity extends AppCompatActivity {
    ...
    private void sendMesssage(String sender, final String receiver, String message){
